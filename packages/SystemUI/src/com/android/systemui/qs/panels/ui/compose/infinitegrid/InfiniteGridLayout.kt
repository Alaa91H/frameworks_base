...
constructor(
    ...
    override fun ContentScope.TileGrid(
        ...
        val useAlternateTileColor = rememberAlternateTileColor()
        ...
        VerticalSpannedGrid(
            ...
            Element(it.tile.spec.toElementKey(), Modifier) {
                Tile(
                    ...
                    useAlternateTileColor = useAlternateTileColor,
                )
            }
        }
    ...
    @Composable
    private fun rememberAlternateTileColor(): Boolean {
        val enabled = remember { mutableStateOf(false) }

        DisposableEffect(tunerService) {
            val tunable =
                TunerService.Tunable { _, newValue ->
                    enabled.value = TunerService.parseIntegerSwitch(newValue, false)
                }
            tunerService.addTunable(tunable, QS_TILE_ALTERNATE_COLOR)
    ...
    private companion object {
        const val QS_TILE_ALTERNATE_COLOR = "system:qs_tile_alternate_color"
    }
}
